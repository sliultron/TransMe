...
import MyBusRoutes from "./myBusRoutes";
...
class AppContainer extends React.Component {
    ...
    render(){
        ...
        <TabBarIOS.Item
          ...
          selected={this.state.selectedTab === 'myBuses'}
          onPress={() => {
            this.setState({
              selectedTab: 'myBuses'
            });
        ...
        <TabBarIOS.Item
          title="Search Stops"
          icon={{uri: base64Icon, scale: 3}}
          selected={this.state.selectedTab === 'searchStops'}
          onPress={() => {
            this.setState({
              selectedTab: 'searchStops',
            });
          }}>
           <SearchStops />
        </TabBarIOS.Item>
         <TabBarIOS.Item
          ...
          onPress={() => {
            ...
            <View>
                  <Text style={{marginTop:40}}>Settings</Text>
             </View>
        </TabBarIOS.Item>
        </TabBarIOS>
        )
